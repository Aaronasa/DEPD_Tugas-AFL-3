...
import 'package:depd_mvvm_25/repository/home_repository.dart';
...
class HomeViewModel with ChangeNotifier {
  ...
  ApiResponse<List<Cost>> costList = ApiResponse.notStarted();
  setCostList(ApiResponse<List<Cost>> response) {
    costList = response;
    notifyListeners();
  }
